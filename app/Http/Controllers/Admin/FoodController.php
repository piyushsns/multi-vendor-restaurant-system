...
class FoodController extends Controller
{
    public function index()
    {
        ...
        return view('admin-views.food.index', compact('categories', 'sub_categories', 'subsub_categories'));
    }
       ...
       $validator = Validator::make($request->all(), [
        ...
        try{
            if ($validator->fails())
            {
                ...
                Log::channel('stderr')->info(33333);
                Log::channel('stderr')->info($food);
                $food->save();
    ...
    public function view($id)
    {
        ...
        return view('admin-views.food.view', compact('product','reviews'));
    }
    ...
    {
        Log::channel('stderr')->info(121212);
        Log::channel('stderr')->info($food);
    ...
    public function edit($id)
    {
        ...
        $addonArr = json_decode($product->add_ons);
        $categories = Category::where(['position' => 0])->get();
        $sub_categories = Category::where(['position' => 1])->get();
        $subsub_categories = Category::where(['position' => 2])->get();
        return view('admin-views.food.edit', compact('product', 'category_ids', 'categories', 'sub_categories', 'subsub_categories', 'addonArr'));
    }
    ...
    public function variant_combination(Request $request)
    {
        ...
        return response()->json([
            'view' => view('admin-views.food.partials._variant-combinations', compact('combinations', 'price', 'product_name'))->render(),
        ]);
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('admin-views.food.list', compact('foods','restaurant','category'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json(['count'=>count($foods),
            'view'=>view('admin-views.food.partials._table',compact('foods'))->render()
        ]);
    }
    ...
    public function review_list(Request $request)
    {
        ...
        return view('admin-views.food.reviews-list', compact('reviews'));
    }
    ...
    {
        return view('admin-views.food.bulk-import');
    }
    ...
    {
        return view('admin-views.food.bulk-export');
    }
